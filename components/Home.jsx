            ...
            <div className='lg:h-[90vh]'>
                <div className="flex flex-col lg:flex-row justify-between gap-12 items-end max-w-screen-2xl mx-auto p-6 lg:h-[85vh] pb-16 lg:pb-0">
                    ...
                    <div className='flex flex-col w-full lg:w-1/2 justify-center items-center h-full relative order-1 lg:order-2'>
                        <img src={Flower} alt="Flower" className='h-48 pr-24 lg:pr-0 lg:h-80 animate-spin-slow-clock relative lg:absolute top-0 lg:top-24 left-2 lg:left-5'/>
                        <img src={Star} alt="Star" className='h-24 pl-32 lg:pl-0 lg:h-56 animate-spin-slow-counter relative lg:absolute bottom-0 lg:bottom-12 right-0 lg:right-6'/>
                    </div>
                </div>
            </div>
        </>
